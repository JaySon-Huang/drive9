...
func emitUploadSummary(summary *client.UploadSummary, localPath string) {
	...
	logger.Info(
		...
		zap.Int("presign_batch_requests", summary.PresignBatchRequests),
		zap.Int("presign_batch_parts_total", summary.PresignBatchPartsTotal),
		zap.Int("max_presign_batch_size", summary.MaxPresignBatchSize),
		zap.Int("server_presign_observed_batches", summary.ServerPresignObservedBatches),
		zap.Float64("server_presign_reported_seconds", summary.ServerPresignReportedSeconds),
		zap.Float64("server_presign_reported_seconds_per_part", summary.ServerPresignReportedSecondsPerPart),
